...
expirydate = datetime.date(2029, 9, 24)
#expirydate = datetime.date(2029, 8, 30)
today=date.today()
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print("Contact me on telegram @starky9680")
        ...
        if (len(numbers)>11):
            ...
            sys.exit(" \n \n \n Contact on Telegram @starky9680")
            #print(numbers)
...
if (now>Third and now<Thirdend):
        ...
        print(" admin on telegram @starky9680 ")
    ...
    print(" on telegram ----@starky9680 for activating")
